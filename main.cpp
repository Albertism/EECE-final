...
int main()
{
    ...
    robotic_arm.MoveServo(0, angle0, 90);
    ...
    while (true)
    {
        ...
        robotic_arm.MoveServo(3, angle3, 100);
        robotic_arm.MoveServo(0, angle0, 50);
        robotic_arm.MoveServo(1, angle1, 70);
        robotic_arm.MoveServo(2, angle2, 100);
        robotic_arm.MoveServo(4, angle4, 50);
    }
}
